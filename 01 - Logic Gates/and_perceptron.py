''' Program to implement 2 input AND gate with single layer Perceptron
    using numpy. Just for understanding weight updation and feedforwarding. '''
...
# output = np.array([(0), (1), (1), (1)]) ---- for OR gate
